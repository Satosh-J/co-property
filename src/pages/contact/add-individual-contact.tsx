...
import { ContactInfo, CONTACT_TAG_TITLE, CONTACT_INDIV_STATUS_TITLE, CONTACT_TAG, CONTACT_INDIV_STATUS } from "types";

export const AddIndividualContact = () => {
	const dispatch = useAppDispatch()	
	const history = useHistory();

    const [tag, setTag] = useState<CONTACT_TAG>("seller");
    const [status, setStatus] = useState<CONTACT_INDIV_STATUS>("no-connect");
		...
		<>
			...
			<div className="co-content-main-wrapper d-flex flex-column flex-1">
				<Card className="fit-content flex-1">
                    <div className="text-small text-desc mb-3">CREATE CONTACT - INDIVIDUAL</div>

                    <Row className="gy-3">
                        <Col md={6} xl={3}>
                            <div className="co-label">Individual Image</div>
                            <Button className="outline-primary w-100 mb-3" icon="upload" size="lg">Upload</Button>

                            <div className="co-label">Name</div>
                            <Input placeholder="First Name" className="mb-2" />
                            <Input placeholder="Last Name" className="mb-3" />

                            <Input label="Company" placeholder="Company Name" icon="search" className="mb-3" />
                            <Input label="Department" placeholder="Department" className="mb-3" />
                            <Input label="Job Title" placeholder="Job Title" className="mb-3" />
                        </Col>
                        <Col md={6} xl={3}>
                        ...
                        <Col md={6} xl={3}>
                            ...
                            <div className="co-group-panel">
                                <div className="tags-panel">
                                    ...
                                    {Object.entries(CONTACT_INDIV_STATUS_TITLE).map(([key, title]) => (
...
export default AddIndividualContact